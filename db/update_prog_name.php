...
<div id="wrapper">
	...
	//		$res=mysql_query("SELECT * FROM b");
			$myQuery = "show columns from prog_name";
...
{
				$query=mysql_query("update prog_name set name='$_POST[name]' where code='$_POST[code]'");
				if(!$query)
				{die("error");}
				else{header("Location:view.php?id=prog_name");}
			}
	?>		
</html>
