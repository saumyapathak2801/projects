...
<div id="wrapper">
	<div id="header-wrapper">
		...
		<div id="banner">
			...
			<?php
			$query=mysql_query("select user from mysql.db where db='rp' ");
...
//			echo "</select></br></br>";
			...
			<input type="checkbox" name="check[]" value="INSERT"/>Insert</br> 
			<input type="checkbox" name="check[]" value="delete"/>Delete</br>
			<input type="checkbox" name="check[]" value="Update"/>Update</br>
			<input type="checkbox" name="check[]" value="select"/>View</br>
			...
			{
		//	echo "<p>".$check."</p>";
			$query=mysql_query("GRANT $check ON rp.* to '$_POST[usr]'@'localhost'");
			if(!$query){die(mysql_error());}
