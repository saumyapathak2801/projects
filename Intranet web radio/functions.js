...
document.getElementById("bar").innerHTML="<span class=\"outer\" style=\"margin-left:350px;margin-top:-480px;opacity:1\"  ><div id=\"bb\"><span><button  id=\"bbb\" href=\"\" class=\"rb mute\" onclick=\"mute()\" style=\"position:absolute;height:140px;width:140px;border-radius:70px;margin-left:30px;margin-top:30px;\"><b>Welcome to SAAM!</b></button></span></div><span class=\"end_mask\" style=\"\"></span><span class=\"start_mask\" style=\"\"></span> <span class=\"mask"+zr+"\"><span class=\"prog\" style=\"\"></span></span><span class=\"mask"+zl+"\"><span class=\"prog\" style=\"\"></span></span><span class=\"circle\"></span>";
}
function mute(){
//soundManager.toggleMute();
soundManager.mute();
document.getElementById("bb").innerHTML="<span><button  href=\"\" class=\"rb unmute\" onclick=\"unmute()\" style=\"position:absolute;height:140px;width:140px;border-radius:70px;margin-left:30px;margin-top:30px;\"><b>Welcome to SAAM!</b></button></span>";

}
function unmute(){
soundManager.unmute();
document.getElementById("bb").innerHTML="<span><button  href=\"\" class=\"rb mute\" onclick=\"mute()\" style=\"position:absolute;height:140px;width:140px;border-radius:70px;margin-left:30px;margin-top:30px;\"><b>Welcome to SAAM!</b></button></span>";
