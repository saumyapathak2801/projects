...
<body>
  <div id="main">
    ...
    <!-- begin header -->
    <header>
      <div id="logo"><h1>IIIT<a href="#">Radio</a></br>..your music..your beat!</h1></div>
      <nav style="margin-top:30px;">
        <ul class="sf-menu" id="nav">
          <li class="selected"><a href="indextemp.php">Home</a></li>
          <li><a href="b22.php">Listen</a></li>
		  ...
		  {
		  if(isset($_SESSION['fac']) && $_SESSION['fac']==0)
		  {
		  echo "<li><a href=\"calendar.html\">Upload Song</a>";
		  echo"<li><a href=\"bakwaas.php?type=announce\">Announcement</a></li>";
		  }
		  
		  echo "<li><a href=\"song_req.php\">Song request</a></li>";
		  echo "<li><a href=\"logout.php\">Logout</a></li>";
		  
		  }
		  else 
		  {
		  echo "<li><a href=\"logcas.php\">Login</a></li>";
		  }
		  ?>
...
<!--	<span class="outer" style="margin-left:350px;">
    <span class="inner">
    </span>
