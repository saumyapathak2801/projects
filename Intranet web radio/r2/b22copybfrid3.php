...
{
echo "<a href='logcas.php' class='topnav'>Login</a>";
}
?>
<?php 
if (isset($_SESSION['user'],$_SESSION['fac']) && $_SESSION['fac']==0)
{
echo "<a href='logout.php' class='topnav'>Logout</a></br>";
echo "<a href='calender.html' class='topnav'>Upload</a>";
}

?>

<?php
/*//$long = id3_get_tag("11.mp3",ID3_V2_3);
//print_r $long;
