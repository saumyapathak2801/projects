...
$rater_ip_vote_qty=5; // how many times an ip address can vote
...
// Assign star image
$query=mysql_query("update songs set rating=$rater_rating where id=$rater_id");
		if(!$query)
		{die(mysql_error());}
...
// Output
echo '<div>';
echo '<form method="post" action="" onload="loadXMLDoc()">';
